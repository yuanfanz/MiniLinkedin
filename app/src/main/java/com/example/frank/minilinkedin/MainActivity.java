package com.example.frank.minilinkedin;
...
import com.example.frank.minilinkedin.model.BasicInfo;
import com.example.frank.minilinkedin.model.Education;
import com.example.frank.minilinkedin.model.Experience;
import com.example.frank.minilinkedin.model.Project;
import com.example.frank.minilinkedin.util.DateUtils;
import com.example.frank.minilinkedin.util.ImageUtils;
import com.example.frank.minilinkedin.util.ModelUtils;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final int REQ_CODE_EDIT_EDUCATION = 1;
    private static final int REQ_CODE_EDIT_EXPERIENCE = 2;
    private static final int REQ_CODE_EDIT_PROJECT = 3;
    private static final int REQ_CODE_EDIT_BASIC_INFO = 4;
